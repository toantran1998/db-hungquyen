<?php
class TileMax_Recent_Posts extends WP_Widget {
	#1.constructor
	function __construct() {
		$widget_options = array('classname'=>'widget_recent_posts', 'description'=>esc_html__('To list out posts', 'designthemes-core'));
		parent::__construct(false,TILEMAX_THEME_NAME.esc_html__(' Posts','designthemes-core'),$widget_options);
	}
			 ...
			 while($the_query->have_posts()):
				...
				echo "<li>";
					...
					if($show_title):
						...
						echo "<div class='entry-title'><h4><a href='".get_permalink()."'>{$title}</a></h4></div>";
						echo "<div class='entry-content'>".tilemax_excerpt(10)."</div>";
					endif;
					
					echo '<div class="entry-meta">';
						echo '<p> <span class="fa fa-clock-o"> </span> '.get_the_date('F').' '.get_the_date('d').'</p>';
						$commtext = "";
