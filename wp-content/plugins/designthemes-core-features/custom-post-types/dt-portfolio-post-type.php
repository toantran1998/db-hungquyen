...
if (! class_exists ( 'DTPortfolioPostType' )) {
	class DTPortfolioPostType {
		...
		function createPostType() {
			...
			$portslug = tilemax_cs_get_option( 'single-portfolio-slug', 'dt_portfolios' );
			$taxslug  = tilemax_cs_get_option( 'portfolio-category-slug', 'portfolio_entries' );
			$tagslug  = tilemax_cs_get_option( 'portfolio-tag-slug', 'portfolio-tags' );
				...
				array(
				  ...
				  'fields' => array(
					...
					array(
					  ...
					  'options'      => array(
						'full-width-portfolio'   => TILEMAX_THEME_URI . '/cs-framework-override/images/portfolio-fullwidth.png',
						'with-left-portfolio'    => TILEMAX_THEME_URI . '/cs-framework-override/images/portfolio-with-left-gallery.png',
						'with-right-portfolio'   => TILEMAX_THEME_URI . '/cs-framework-override/images/portfolio-with-right-gallery.png',
					  ),
