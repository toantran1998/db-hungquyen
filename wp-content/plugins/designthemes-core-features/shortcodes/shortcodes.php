...
class DTCoreShortcodesDefination {
	...
	function dt_sc_twitter_tweets($attrs, $content = null) {
		...
		if($username && $consumerkey && $consumersecret && $accesstoken && $accesstokensecret) {
			...
			require_once(TILEMAX_CORE_PLUGIN."/apis/twitteroauth/twitteroauth.php");
				...
				$out .= '<article id="post-'.$id.'" class="'.esc_attr($post_classes).'">';
					switch( $style ):
						...
						case 'entry-date-left':
							ob_start();
							$obj->tilemax_post_date_left_style( $id, $meta );
							$out .= ob_get_clean();
						break;

						case 'entry-date-author-left':
							ob_start();
							$obj->tilemax_post_date_author_left_style( $id, $meta );
							$out .= ob_get_clean();
						break;
						...
						default:
							ob_start();
							$obj->tilemax_post_default_style( $id, $meta );
							$out .= ob_get_clean();
						break;
	...
	function dt_sc_down_count($attrs, $content = null) {
		...
		$out .= '<div class="downcount '.$class.'" data-date="'.tilemax_cs_get_option('comingsoon-launchdate', date('m/d/Y')).'" data-offset="'.tilemax_cs_get_option('comingsoon-timezone', '0').'">';
	...
	function dt_sc_post_social_share($attrs, $content = null) {
		...
		$out = '<div class="share">';
			$out .= '<a href="#">'.esc_html__('Share', 'designthemes-core').'</a>';
